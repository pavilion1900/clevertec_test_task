...
class ProductManagerTest {
    ...
    void whenFindAllCards() {
        CustomList<Card> expected = manager.findAllCards(out, in, storeOfItems, storeOfCards);
    ...
    void whenFindAllItems() {
        CustomList<Item> expected = manager.findAllItems(out, in, storeOfItems, storeOfCards);
    ...
    void whenMakeOrder() {
        ...
        manager.makeOrder(out, in, storeOfItems, storeOfCards);
